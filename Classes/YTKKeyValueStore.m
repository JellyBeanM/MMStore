...
static NSString *const ENCRYPTED_KEY = @"10010326";
...
- (id)initDBWithName:(NSString *)dbName {
    return [self initDBWithName:dbName byEncrypted:NO];
}

- (id)initDBWithName:(NSString *)dbName byEncrypted:(BOOL)encrypted {
    self = [super init];
    if (self) {
